...
- For high-performance web service using Flask framework might not be the best web framework to service millions of user. Languages like Java and Frameworks like Spring, Play or any J2EE application/service framework would probably be better suited
